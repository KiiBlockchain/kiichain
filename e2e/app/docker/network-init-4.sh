...
CONTAINER0="kiichaind-node0"
CONTAINER1="kiichaind-node1"
CONTAINER2="kiichaind-node2"
CONTAINER3="kiichaind-node3"
...
# docker exec -it kiichaind-node0 bash -c "/scripts/seed-start.sh"
# docker exec -it kiichaind-node1 bash -c "/scripts/seed-start.sh"
# docker exec -it kiichaind-node2 bash -c "/scripts/seed-start.sh"
# docker exec -it kiichaind-node3 bash -c "/scripts/seed-start.sh"
