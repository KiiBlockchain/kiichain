...
func init() {
	...
	DefaultNodeHome = filepath.Join(userHomeDir, ".kiichaind")
}
...
type SimApp struct {
	...
	*polarruntime.Polaris
	...
	NewPolarisApp func(log.Logger, dbm.DB, io.Writer, bool, string, servertypes.AppOptions, ...func(*baseapp.BaseApp)) *SimApp
}
