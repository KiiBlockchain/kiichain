...
// genesisCommand builds genesis-related `kiichaind genesis` command.
...
func appExport(
	...
	if height != -1 {
		testApp = testapp.NewPolarisApp(logger, db, traceStore, false, "kii", appOpts)

		if err := testApp.LoadHeight(height); err != nil {
			return servertypes.ExportedApp{}, err
		}
	} else {
		testApp = testapp.NewPolarisApp(logger, db, traceStore, true, "kii", appOpts)
	}
...
var tempDir = func() string {
	dir, err := os.MkdirTemp("", ".kiichaind")
	if err != nil {
