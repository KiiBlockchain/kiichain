...
LOCALNET_CLIENT_PATH = ./e2e/precompile/kiichaind
...
CLIENTS_PATH := $(CLONE_PATH)/clients/kiichaind/
SIMULATIONS := \
...
hive-setup:
	...
	@cp -rf $(BASE_HIVE_DOCKER_PATH)/clients/kiichaind $(CLIENTS_PATH)
	@echo "Copying files...";
...
test-hive:
	@cd $(CLONE_PATH) && \
		hive --sim polaris/rpc -client kiichaind

test-hive-v:
	@cd $(CLONE_PATH) && \
		hive --sim polaris/rpc -client kiichaind --docker.output
